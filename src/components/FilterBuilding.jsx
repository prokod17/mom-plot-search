  ...
  const handleSelectedRarity = ( rarity ) => {
    ...
    < >
     ...
     <div className="filters-div-child">
       <label id="lbl-dpBuilding" className="label-dpMenu">Select Building </label>
      
       <select className="dropDown" id="lbl-dpBuilding"
      ...
      <div className="filters-div-child" id="div-rarity">
        <label className="label-dpMenu">Select Rarity </label>
          <select className="dropDown" disabled={haveRarity} onChange={ (e) => handleSelectedRarity( e.target.value )}>
